...
export const metadata: Metadata = {
  ...
  description:
    "Review Crystaline ERP subscription terms, licensing, and support scope.",
  ...
  return (
    <div className="space-y-10">
      <PageBanner
        ...
        subtitle="Crystaline ERP subscriptions include software licensing, support SLAs, and fair-use of integrations. Below is a concise summary."
      />
      <section className="space-y-6 rounded-3xl border border-slate-100 bg-white p-8 shadow-sm text-sm text-slate-600">
        <p>
          ...
          data at all times. Crystaline ERP provides platform access, updates, and
        ...
        <p>
          ...
          hardware provided remains Crystaline ERP property until fully paid.
